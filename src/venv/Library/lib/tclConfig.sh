...
# installed.
TCL_PREFIX='D:/AgenticAI/AgenticAI-LangChain-LangGraph/src/venv\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='D:/AgenticAI/AgenticAI-LangChain-LangGraph/src/venv\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='D:/AgenticAI/AgenticAI-LangChain-LangGraph/src/venv\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-ID:/AgenticAI/AgenticAI-LangChain-LangGraph/src/venv\Library\include'
...
TCL_PACKAGE_PATH='D:/AgenticAI/AgenticAI-LangChain-LangGraph/src/venv\Library\lib'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LD:/AgenticAI/AgenticAI-LangChain-LangGraph/src/venv\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='D:/AgenticAI/AgenticAI-LangChain-LangGraph/src/venv\Library\lib\tclstub86.lib'
